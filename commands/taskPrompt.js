...
module.exports = {
  ...
  description: "Add a task to your reply prompt",
  execute(message, args) {
    if (message.channel.type !== "dm") {
        return message.reply("private DM me with `!task` :bomb:");
    }
